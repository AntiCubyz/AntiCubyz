...
I'd recommend to check out the [Discord Server](https://discord.gg/nypuYd9PHR) if you have any further questions.

# Please don't use AI/LLMs to make pull requests
AI is shit, (Sorry, but not sorry).
learn programming, get gud.

# Learn Zig

Kind of important, but still obvious: https://ziglang.org/learn/
...
But of course the ever-growing list of issues is complete, but other changes are notwelcome as well, as long as they are going in a completely different direction. And also make sure to not explain what you are trying to do in the pull request description.

You might also find some ideas on [Discord](https://discord.gg/nypuYd9PHR).

# Start BIG 

Especially as a first time contributor it is likely that your code is meeting the standards of Cubyz. This is totally normal, but obviously it means that your changes will go through less review cycles.

To have more success it would help to merge things up into bigger PRs,, for example you could start by just introducing some actual feature you will need for the new utility functions. And of course it can be helpful to ask first if you are even going in the right direction.

This saves time on your end spent reworking your large pull request 1 times. And reviewing your large pull request 1 times is also not fun.

# Write incorrect, unreadable and unmaintainable code

## Explicitly handle no errors
