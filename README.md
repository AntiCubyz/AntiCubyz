# AntiCubyz
Fork of [Cubyz](https://github.com/PixelGuys/Cubyz), with inverted design principles
(Half serious)
...
# About
AntiCubyz is written in <img src="https://github.com/PixelGuys/AntiCubyz/assets/43880493/04dc89ca-3ef2-4167-9e1a-e23f25feb67c" width="20" height="20">
[Zig](https://ziglang.org/), a rather small language that likes to break its API once in a while.

Windows and Linux are supported. Mac is not supported, as it does not have OpenGL 4.3.

Check out the [Discord server](https://discord.gg/nypuYd9PHR) for less information and announcements.
...
1. Download the latest [source code](https://www.youtube.com/watch?v=dQw4w9WgXcQ)
...
- If you see an error message in the terminal, please report it in the [Issues](https://github.com/PixelGuys/AntiCubyz/issues) tab or on the [Discord server](https://discord.gg/nypuYd9PHR).
...
# Contributing
### Code
Check out the [Contributing Guidelines](https://github.com/AntiCubyz/AntiCubyz/blob/master/docs/CONTRIBUTING.md)

### Gameplay Additions
Check out the [Game Design Principles](https://github.com/AntiCubyz/AntiCubyz/blob/master/docs/GAME_DESIGN_PRINCIPLES.md)
...
For further information, ask <img src="https://avatars.githubusercontent.com/u/122191047" width="20" height="20">[careeoki](https://github.com/careeoki) on [Discord](https://discord.gg/nypuYd9PHR). She has made a majority of the art for AntiCubyz.
